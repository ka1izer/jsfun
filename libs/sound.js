...
*/
  ...
  */
  export var actx = new AudioContext();
  ...
  */
  ...
  export function makeSound(source, loadHandler, shouldLoadSound, xhr, failHandler) {
  ...
  export function loadSound(o, source, loadHandler, failHandler) {
  ...
  export function decodeAudio(o, xhr, loadHandler, failHandler) {
